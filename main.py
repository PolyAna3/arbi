...
#----main-options----#
switch_cex = "bybit"       # binance, mexc, kucoin, gate, okx, huobi, bybit
symbolWithdraw = "MATIC"      # символ токена
network = "MATIC"     # ID сети
proxy_server = "http://login:password@IP:port"

#----second-options----#
amount = [2.7, 3]          # минимальная и максимальная сумма
decimal_places = 2           # количество знаков, после запятой для генерации случайных чисел
delay = [10, 30]             # минимальная и максимальная задержка
